...
export const ContextProvider = ({ children }) => {
    const [navLinks, setNavLinks] = useState([
        ...
        {id: 4, name: 'Поставки', path: '/sent', isActive: false},
    ...
    const [complects, setComplects] = useState([
        {id: 17, name: 'Ком. 50м на трубке шаг 20 см', article: 'bgr-wp-50-1', count: 0, price: 0, structure: [
        ...
        {id: 18, name: 'Ком. 100м на ленте шаг 20 см', article: 'bgr-wp-100', count: 0, price: 0, structure: [
        ...
        {id: 19, name: 'Ком. 100м на ленте шаг 10 см', article: 'К-100Л-10', count: 0, price: 0, structure: [
